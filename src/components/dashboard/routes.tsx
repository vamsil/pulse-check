...
export default function Routes() {
  return (
    ...
    <Switch>
      ...
      <Route exact path="/database/account"><AccountInformation /></Route>
      <Route exact path="/pulseCheck/database/dashboard"><DatabaseDashboard /></Route>
  {/*    <Route exact path="/database"><Redirect to="/dashboard/database/dashboard"/></Route>
